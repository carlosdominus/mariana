  ...
  return (
    <div className="relative text-white py-12 md:py-20 animate-fade-in" id="proposta-container">
      ...
      <div className="space-y-3.5 max-w-4xl mx-auto text-center mb-10 md:mb-14 px-4 select-none">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#41F20A]/10 border border-[#41F20A]/20 text-[#41F20A] text-[10px] md:text-xs font-bold tracking-widest rounded-full uppercase font-sans">
          <Coins size={12} />
          PROVISÃO FINANCEIRA COPRODUÇÃO
        </div>
        
        {/* Title optimized to occupy max 2 lines easily on desktop/mobile */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-black uppercase tracking-tight leading-tight text-white max-w-2xl mx-auto">
