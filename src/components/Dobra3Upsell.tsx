...
export default function Dobra3Upsell({ onNext, onPrev }: Props) {
  return (
    <div className="relative text-white py-12 md:py-20" id="upsell-container">
      ...
      <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] bg-[#19ffa2]/5 rounded-full blur-[110px] pointer-events-none" />

      {/* Header Section */}
      <div className="space-y-4 max-w-3xl text-left mb-12 md:mb-16">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-900 border border-[#19ffa2]/20 text-emerald-400 text-[10px] font-bold tracking-widest rounded-full uppercase font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start relative z-10">
        ...
        <div className="space-y-4">
          <h3 className="text-md font-heading font-extrabold uppercase text-red-400 tracking-wide border-l-2 border-red-500 pl-3">
        ...
        {/* Right Side: Pro Flow */}
        <div className="space-y-4">
          <h3 className="text-md font-heading font-extrabold uppercase text-[#19ffa2] tracking-wide border-l-2 border-[#19ffa2] pl-3">
            Isso é oque acontece com os grandes players:
          </h3>
          <div className="rounded-2xl overflow-hidden border border-[#19ffa2]/15 bg-zinc-950/40 p-2 shadow-xl shadow-[#19ffa2]/5">
            <img 
